...
$a->setNamespace('sf_orm_default_4ea89af98c4bbb7c4d7e21e5e2ea449378d7c59b6f84763a10758372c0589b03');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_4ea89af98c4bbb7c4d7e21e5e2ea449378d7c59b6f84763a10758372c0589b03');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_4ea89af98c4bbb7c4d7e21e5e2ea449378d7c59b6f84763a10758372c0589b03');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CommentRepository' => function () {
    return ($this->privates['App\Repository\CommentRepository'] ?? $this->load(__DIR__.'/getCommentRepositoryService.php'));
}, 'App\\Repository\\PostRepository' => function () {
