...
class Comment extends \App\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Comment' . "\0" . 'createdTime', '' . "\0" . 'App\\Entity\\Comment' . "\0" . 'message', '' . "\0" . 'App\\Entity\\Comment' . "\0" . 'fbId', '' . "\0" . 'App\\Entity\\Comment' . "\0" . 'post'];
        }
